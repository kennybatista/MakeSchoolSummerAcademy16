...
let brothers = ["Erik", "Isaias", "Edwin", "Kenny"].joinWithSeparator(" and ")
...
print(" I adore \(awesome) walks on the \(park) with my pet \(dog), named \(bolt). We enjoy singing \(genre) music while we \(fight) together")
