...
*/
    // All the objects in this array would have to be of the same type, that is because groceryList is of type String.
 ...
 */
//Practice
let names : [String] = ["Kenny", "Erik", "Isaias", "John", "David"]
let numberOfNames = names.count
print("There are \(numberOfNames) names in the names array")
...
*/
//Challenge
//Since our array is a mutable variable we are able to append to it. Unlike if it was a constant variable
var chores : [String] = ["Wake Up", "Wash the dishes", "Milk the cows"]

chores.append("Churn butter")

chores += ["Call the cows"]

print(chores[0])

var currentTask : Int = 0

print(chores[currentTask])

currentTask += 1

print(chores[currentTask])

//chores[currentTask] ---- this is called the subscript syntax
