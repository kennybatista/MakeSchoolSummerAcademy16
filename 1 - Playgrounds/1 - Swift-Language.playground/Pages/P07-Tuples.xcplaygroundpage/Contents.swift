...
var usMoney : (String, Double) = ("usd", 1.00)
var canadaMoney : (String, Double) = ("cad", 1.00 * 1.29)
var australianMoney : (String, Double) = ("aud", usMoney.1 * 1.36)

print("\(usMoney.1) is \(usMoney.0), \(canadaMoney.1) is \(canadaMoney.0), \(australianMoney.1) is \(australianMoney.0)")
