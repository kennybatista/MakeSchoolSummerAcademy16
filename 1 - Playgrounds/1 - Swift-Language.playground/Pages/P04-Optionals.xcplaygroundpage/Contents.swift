...
let theMiddleName = middleName ?? "AnyMiddleName"


var haveAppleWatch : Bool?
print(haveAppleWatch)
haveAppleWatch = nil
print(haveAppleWatch)
//print(haveAppleWatch!)  // we can't unwrap because there is no value. It's like trying to take out an object that doesn't exist out of a box.
if let haveAppleWatch = haveAppleWatch {
    print(haveAppleWatch)
} else {
    "There is no apple watch"
}

var defaultAnswer = haveAppleWatch ?? true
