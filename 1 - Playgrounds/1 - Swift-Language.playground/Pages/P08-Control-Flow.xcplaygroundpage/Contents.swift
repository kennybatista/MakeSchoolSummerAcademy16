...
var instructors : [String] = ["Daniel", "Martin", "Stephen", "Ann", "Adam", "Dion", "Mike"]
print(instructors)
...
for instructor in instructors {
    if instructor == "Frango" {
        print("You've found Frango")
        break
    }
}

//Game objects represent their horizontal position with an X value.
//The screen is 375 points wide
//When x is less than 0 or when x is greater than 375, velocity needs to be inverted
//I.E, if the velocity was 10 and the x position of the object was 375, veclocity would become -10.
//TASK: Recreate this example in code, print the velocity to sow that it changed to -10.

var wideScreen : Int = 375
var objectsXPosition = 110

while objectsXPosition < 0 || objectsXPosition > 375 {
    //velocity inverted.
    if objectsXPosition < 0 {
        objectsXPosition += 1
     } else {
        print("Error")
    }
    
    if objectsXPosition > 375 {
        objectsXPosition -= 1
    } else {
        print("Error")
    }
