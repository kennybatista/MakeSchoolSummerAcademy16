...
//If we have an array, it's like saying give me all of the mail in the mailbox. But if we ue dictionaries, it's like saying "give me all of the mail for : Kenny". 

var instructors = [String: String]() //empty dictionary
var emptyDic : [String: String] = [:] //another empty

instructors["Wendy"] = "Zhang"

print(instructors["Wendy"])

//print(instructors["Wendy"]!)

if let name = instructors["Wendy"] {
    print(" The name is \(instructors["Wendy"])")
} else {
...
//tracks["Apps"] = ["John Stamos", "Brittney Spears", "Daisy Buchanan"]
